...
<?php else : ?>
	...
	<form method="post">
		...
		<div class="woocommerce-address-fields">
			...
			<p class="clearfix">
				<button type="submit" class="button btn-lg btn-primary btn-go-shop mt-3 pt-right" name="save_address" value="<?php esc_attr_e( 'Save address', 'woocommerce' ); ?>"><?php esc_html_e( 'Save address', 'woocommerce' ); ?><i class="icon icon_btn_arrow white"></i></button>
