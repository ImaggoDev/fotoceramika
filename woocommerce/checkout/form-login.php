...
<?php else : ?>
	...
	<i class="icon_form icon_form--login"></i><?php echo esc_html__( 'Returning customer?', 'woocommerce' ) . ' <a href="#" class="showlogin font-weight-bold text-v-dark">' . esc_html__( 'Kliknij, aby się zalogować', 'woocommerce' ) . '</a>'; ?>
	</div>
<?php endif; ?>
