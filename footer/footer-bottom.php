...
if ( ( $porto_settings['footer-logo'] && $porto_settings['footer-logo']['url'] ) || is_active_sidebar( 'footer-bottom' ) || $porto_settings['footer-copyright'] ) :
	...
	<div class="container">
			...
			<div class="payments">
                ...
                <img class="payments--logo paynow" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/porto-child/assets/icons/paynow.png" alt="">
                <img class="payments--logo" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/porto-child/assets/icons/mastercard.svg" alt="">
                <img class="payments--logo" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/porto-child/assets/icons/visa.svg" alt="">
                <img class="payments--logo" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/porto-child/assets/icons/blik.svg" alt="">
            </div>
            <div class="delivery">
                <p>Dostawy zapewnia</p>
                <img class="delivery--logo poczta-polska" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/porto-child/assets/icons/poczta_polska.svg" alt="">
                <img class="delivery--logo" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/porto-child/assets/icons/inpost.svg" alt="">
                <img class="delivery--logo ups" src="<?php echo esc_url( home_url() ); ?>/wp-content/themes/porto-child/assets/icons/ups.svg" alt="">
            </div>
			</div>
	</div>
